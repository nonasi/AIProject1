...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
#        print "goals: ", self.corners
#        print "state b4 isGoal", state
#        print " ====== ", state[0] == self.goal[3]
...
#        print "state after isGoal", state
...
#        print "this is the state from corners problem: ", state
    ...
    #    print "allScuccessors from getSucc.: ", successors
        return successors
